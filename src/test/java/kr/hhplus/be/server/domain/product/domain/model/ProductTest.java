...
class ProductTest {
    ...
    void 재고_충분() {
        // given
        Product product = new Product(1L, "테스트상품", 1000L, 10);
    ...
    void 재고_부족() {
        Product product = new Product(1L, "테스트상품", 1000L, 5);
    ...
    void 재고차감_정상() {
        // given
        Product product = new Product(1L, "상품", 2000L, 10);
    ...
    void 재고차감_음수예외() {
        // given
        Product product = new Product(1L, "상품", 2000L, 2);

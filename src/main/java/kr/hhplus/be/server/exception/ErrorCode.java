...
public enum ErrorCode {
     ...
     * COUPON
     */
    COUPON_POLICY_NOT_FOUND(-1200, "COUPON POLICY NOT FOUND", HttpStatus.NOT_FOUND),
    COUPON_NOT_FOUNT(-1201, "COUPON NOT FOUND", HttpStatus.NOT_FOUND),
    COUPON_INVALID_STATUS(-1202, "INVALID COUPON STATUS", HttpStatus.BAD_REQUEST),
    ALREADY_ISSUED_COUPON(-1203, "ALREADY USED COUPON", HttpStatus.BAD_REQUEST),
    COUPON_SOLD_OUT(-1204, "COUPON SOLD OUT", HttpStatus.BAD_REQUEST),
